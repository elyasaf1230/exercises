...
/*
	...
	OUTPUT:
		int - the popped out value. 
		(-1 if error, 'queue' is NULL, no one call to initqueue(), no values in queue ect...) 
*/
int pop(Queue* queue);
...
/*
	...
	OUTPUT:
		int - the first value in 'queue' (-1 if error, 'queue' == NULL, 'queue' is empty ect...)
*/
int top(Queue* queue);
